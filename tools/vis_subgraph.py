...
graph_a = pickle.load(open('/home/mrduan/projects/RRCNN/Reasoning-RCNN/tools/graph/new_COCO_graph_a.pkl', 'rb'))
graph_r = pickle.load(open('/home/mrduan/projects/RRCNN/Reasoning-RCNN/tools/graph/new_COCO_graph_r.pkl', 'rb'))
...
f, (ax1,ax2) = plt.subplots(figsize=(80,40), ncols=2)
...
plt.savefig('/home/mrduan/projects/RRCNN/Reasoning-RCNN/work_dirs/vis/subgraph_COCO.png')
plt.show()